...
<div class="rightinnerdiv1">   
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                $table.="<td><a href='deleteuser.php?useriddelete=$row[0]'><button type='button' class='btn btn-primary'>Delete</button></button></a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
 ...
 <div class="rightinnerdiv1">   
            ...
            foreach($recordset as $row){
              ...
              //  $table.="<td><button type='button' class='btn btn-primary'><a href='deletebook_dashboard.php?deletebookid=$row[0]'>Delete</a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
